...
public class Problem {
	...
	/*
	 * per line: ITEMID | MACHINE_1_Prod/hr | MACHINE_2_Prod/hr | MACHINE 3....
	 */
	...
	public Problem(String filename) {
		try {
			...
			// temp, should be overwritten in real instances using the
			// .setOutputFile(String)-function.
			...
			// Shipping day matrix [#request X #shipping_day]. [i,j] is 1 if request i can
			// be shipped on day j, 0 otherwise
			...
			// Requested items matrix [#request X #items]. position [i,j] represents: number
			// of items j requested by request i
	...
	public int getTechnicianStartIndex() {
		return technicianStartIndex;
	}

	public void setTechnicianStartIndex(int technicianStartIndex) {
		this.technicianStartIndex = technicianStartIndex;
	}

	public int getTechnicianStopIndex() {
		return technicianStopIndex;
	}

	public void setTechnicianStopIndex(int technicianStopIndex) {
		this.technicianStopIndex = technicianStopIndex;
	}

	public int getLastDayShiftIndex() {
		return lastDayShiftIndex;
	}

	public void setLastDayShiftIndex(int lastDayShiftIndex) {
		this.lastDayShiftIndex = lastDayShiftIndex;
	}

	public int getLastOvertimeIndex() {
		return lastOvertimeIndex;
	}

	public void setLastOvertimeIndex(int lastOvertimeIndex) {
		this.lastOvertimeIndex = lastOvertimeIndex;
	}

	public int getMinimumConsecutiveNightShifts() {
		return minimumConsecutiveNightShifts;
	}

	public void setMinimumConsecutiveNightShifts(int minimumConsecutiveNightShifts) {
		this.minimumConsecutiveNightShifts = minimumConsecutiveNightShifts;
	}

	public int getPastConsecutiveNightShifts() {
		return pastConsecutiveNightShifts;
	}

	public void setPastConsecutiveNightShifts(int pastConsecutiveNightShifts) {
		this.pastConsecutiveNightShifts = pastConsecutiveNightShifts;
	}

	public double getCostOfOvertimePerBlock() {
		return costOfOvertimePerBlock;
	}

	public void setCostOfOvertimePerBlock(double costOfOvertimePerBlock) {
		this.costOfOvertimePerBlock = costOfOvertimePerBlock;
	}

	public double getCostOfNightShift() {
		return costOfNightShift;
	}

	public void setCostOfNightShift(double costOfNightShift) {
		this.costOfNightShift = costOfNightShift;
	}

	public double getCostOfParallelDay() {
		return costOfParallelDay;
	}

	public void setCostOfParallelDay(double costOfParallelDay) {
		this.costOfParallelDay = costOfParallelDay;
	}

	public double getCostPerItemUnderMinimumStock() {
		return costPerItemUnderMinimumStock;
	}

	public void setCostPerItemUnderMinimumStock(double costPerItemUnderMinimumStock) {
		this.costPerItemUnderMinimumStock = costPerItemUnderMinimumStock;
	}

	public int[][] getMachineEfficiencies() {
		return machineEfficiencies;
	}

	public void setMachineEfficiencies(int[][] machineEfficiencies) {
		this.machineEfficiencies = machineEfficiencies;
	}

	public boolean[][] getIsLargeChangeover() {
		return isLargeChangeover;
	}

	public void setIsLargeChangeover(boolean[][] isLargeChangeover) {
		this.isLargeChangeover = isLargeChangeover;
	}

	public int[][] getChangeoverDurations() {
		return changeoverDurations;
	}

	public void setChangeoverDurations(int[][] changeoverDurations) {
